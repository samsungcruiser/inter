			...
			<div class="related-posts clear">
                ...
                while( $new_query->have_posts() ) :
                    ...
                    <?php if ( 'thumbnail' == $pls_rp_style ) { ?>
                        <a class="rp-thumb" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo $img; ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/></a><h4><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h4>
					<?php }
                    else { ?>
