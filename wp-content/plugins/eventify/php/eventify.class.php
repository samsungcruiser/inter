...
?>
		...
		<h4>If you use this plugin, I do humbly request you to <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
		...
		</form><br/><br/>It will help me to keep this plugin updated and managed. If you have any request, or would like to know what others are requesting for eventify, <a href="http://designerfoo.uservoice.com/" target="_new">click here</a>.</h4>
				...
				endforeach;		
					...
					$caldrw.='		
						...
						eventRender: function(event,element)
						{
							...
							element.qtip({
								content : \'<h4 class="bubbletext">\'+event.title+\'</h4><span class="starttd"><strong>Start:</strong>\'+event.start+\'</span><br/><span class="endid"><strong>End:</strong>\'+event.end+\'</span><br/><span class="eventdescription"><strong>Description:</strong>\'+event.description+\'</span><br/><span class="eventvenue"><strong>Venue:</strong>\'+event.venue+\'</span><br/><span class="eventtimezone"><strong>Timezone:</strong>\'+event.timezone+\'</span><br/>\',
