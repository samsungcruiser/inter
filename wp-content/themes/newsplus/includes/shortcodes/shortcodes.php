...
function slider( $atts, $content = null ) {
	...
	$out .= '<div class="flexslider flex-loading" id="' . $slider_id . '"><div class="slides">' . return_clean( $content, false, true ) . '</div></div><div class="flex-controls-container main-slider" id="' . $slider_id . '-controls"></div></div>';
	return $out;
}
...
function posts_slider( $atts ) {
    ...
    if ( $custom_query->have_posts() ) :
		...
		endwhile;
		$out .= '<div class="flexslider flex-loading" id="' . $slider_id . '"><div class="slides">' . $slides . '</div></div><div class="flex-controls-container main-slider" id="'.$slider_id.'-controls"></div>';
		return $out;
	endif;
	wp_reset_query();
